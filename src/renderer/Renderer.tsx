...
try {
    ...
    console.log("This is Alicorn Again: SakuraKumo. Dedicated to my loved game.");
    console.log("%c❤ From Annie K Rarity Sparklight", "color:#df307f;");
    console.log(
        "%cSparklight is a girl - a filly, to be accurate.",
        "color:#df307f;"
    );
    console.log("Here is skjsjhb. Make Alicorn usable again.");
    console.log("Life is better if you upgrade to NeoForge.");
    console.log(
    ...
    console.log(
        'Alicorn Again Launcher Copyright (C) 2023 Ted "skjsjhb" Gao'
    );
    console.log(
    ...
    void (async () => {
        ...
        if (getBoolean("clean-storage")) {
            ...
            console.log("Storage data cleaned.");
